...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "ANJU-XPRO~CBFhgZxT#b0rmikctx9vGU8pO_BwcjBeY5-dVQdyxM0UB2-C52Aw",
    GITHUB_TOKEN: process.env.GITHUB_TOKEN || "github token without ghp_",
    GITHUB_USERNAME: process.env.GITHUB_USERNAME || "Bbclen bot",
    SUDO: process.env.SUDO ? process.env.SUDO.split(".") : ["237675556199"],
